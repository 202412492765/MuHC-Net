...
├── data/
│   ├── BRCA/                     # Preprocessed multi-omics data 
...
│   │   ├── result_CI/            # CI prognosis outputs
│   │   │   ├── data/             # AE representations + clinical
...
│   │   │   │   └── BRCA_clinical_delete_process.csv
│   │   │   ├── models/           # AE model weights
│   │   │   │   └── ae_model.pth
│   │   │   └── model_hgnn_v2/    # CI best models + summary
...
│   │   │       └── final_summary.json
│   │   └── result_AUC/           # AUC classification output
...
│   └── LAML/
├── checkpoints/
